...
<head>
    ...
    <title>Gaminity - Contact Page</title>
...
<body>
    ...
    <div class="container">
    <div class="card my-5 p-4 text-white text-center" style="background: rgba(25, 40, 65, 1); font-size: 30px; font-weight: bold;">
        Contact Us
    </div>

    <div class="card my-5 p-4 text-white" style="background: rgba(25, 40, 65, 1); font-size: 25px;">
